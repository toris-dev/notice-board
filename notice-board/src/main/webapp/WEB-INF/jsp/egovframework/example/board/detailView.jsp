...
<body>
	<div class="container">
		...
		<div class='post-wrap'>
			...
			<div class="post-info">
				<span class="post-date">${post.getAuthorId()}</span> <span
					class="post-date">${post.getCreatedAt()}</span>
			</div>
			<hr class="line" />
			...
			<c:forEach var="comment" items="${comments}">
				<div class="comment-wrap">
					<div class="comment-info">
						<span class="comment-author">${comment.getAuthorId()}</span> <span
							class="comment-date"> <fmt:formatDate
								value="${comment.getCreatedAt()}" pattern="yyyy.MM.dd HH:mm" /></span>
					</div>
